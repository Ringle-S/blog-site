...
Route::get('/my_blog', [HomeController::class,'my_blog'])->middleware('auth');
...
Route::post('/update_my_post/{id}', [HomeController::class,'update_my_post'])->middleware('auth');
Route::get('/contactus', [HomeController::class,'contactus'])->name('contactus'); 
Route::post('/update_contact', [HomeController::class,'update_contact']); 
